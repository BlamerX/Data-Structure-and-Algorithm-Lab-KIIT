// Modify the program HE8.2 by providing more options as follows:
// a) To print height and depth of a node of the binary tree.
// b) To print height and depth of the binary tree.
// c) To find nodes which are at maximum depth in binary tree.
...
int main()
{
    ...
    while (1)
    {
        ...
        case 9:
            while (1)
            {
                printf("\n1. To print height and depth of a node of the binary tree. \n2. To print height and depth of the binary tree. \n3. To find nodes which are at maximum depth in binary tree.\n4. Exit \nEnter your choice: ");
                scanf("%d", &sw);
                switch (sw)
                {
                case 1:
